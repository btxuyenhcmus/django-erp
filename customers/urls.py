...
from customers.views.copy_customer_views import CopyCustomer
...
urlpatterns = [
    ...
    path('delete/<int:pk>', DeleteCustomer.as_view(), name='delete_customer'),
    path('copy/<int:pk>/', CopyCustomer.as_view(), name='copy_customer'),
